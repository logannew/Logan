...
contract  Pool is PoolWrapper, Auth {
    ...
    constructor(
        ...
        rewardRate = uint(rewardRate_).div(DURATION);
        periodFinish = starttime + (days_ * 24 * 3600);
    }
    ...
    function setPeriodFinish(uint periodFinish_) public auth {
    ...
    function balanceOfPool() public view returns (uint) {
        return basisCash.balanceOf(address(this));
    }
